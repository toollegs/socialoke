...
function getOutput() {
	...
	#$fullret="<html><head><title>Set Gigs</title>";
	#$fullret.='<script>$( "#postgigs" ).click(function() { alert("Yay!"); }); </script>';
	#$fullret.="<script src='//code.jquery.com/jquery-1.10.2.js'></script>";
	#$fullret.='</head><body>';
