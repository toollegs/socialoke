...
function doRemind()
{
	...
	foreach($who as $host => $gig) {
		...
		if ($fc > 0) {
			...
			doSMS($knownHosts[$host],"To turn on Socialoke from your computer for tonight's gig at ".$gig.", click the Start button on your dashboard at http://s-oke.com/dboard/".$host);
		}
