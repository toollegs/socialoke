...
$ph=session_get('ph');
$f = file('/var/www/html/beta/jeff-cathay_021714,1400/core/artist/'.$firstletter.'.csv');
$songs = array();
foreach($f as $song) {
...
//		$smsstring = str_replace('%26apos%3B','',$smsstring);
		$href = "/beta/jeff-cathay_021714,1400/core/sm/sm.php?s=".str_replace(' - ','+by+',$smsstring);
?>
